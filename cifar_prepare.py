...
from corruption import make_cifar10_c, make_cifar100_c, make_imagenet_c,make_cinic10_c,make_food101_c,make_stanfordcars_c
from corruption.make_tiny_imagenet_c import make_tinyimagenet_c  # 假设模块中有同名函数
    ...
    *partitions, partition_idxs = create_partition(datasets, args)
    ...
    if args.corruption == "ood" or args.corruption == "iid":
        ...
        if args.dataset == 'cifar10':
            ...
            cifar_c, labels, corruption = make_cinic10_c(partition_idxs, is_train, data_dir=args.data_dir,
                                                          mode=args.corruption)


        elif args.dataset == 'imagenet':
            cifar_c, labels, corruption = make_imagenet_c(partition_idxs, is_train, data_dir='/mnt/sda/PythonProject/Learning_Dataset',
                                                          mode=args.corruption)
            ...
            cifar_c, labels, corruption = make_food101_c(partition_idxs, is_train, data_dir=args.data_dir,
                                                          mode=args.corruption)

        elif args.dataset == 'stanfordcars':
            cifar_c, labels, corruption = make_stanfordcars_c(partition_idxs, is_train, data_dir=args.data_dir,
                                                          mode=args.corruption)
