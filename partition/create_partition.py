...
from .stat import print_quantity_stat, print_label_distribution_stat,print_label_distribution_stat_office_home

def create_partition_office_home(datasets, args, environment):
    i = environment
    ...
    #print_label_distribution_stat_office_home(dataset, num_labels, partition_idxs, visualize=args.visualize, resize=0.2, environment=i)
