...
def create_fed_dataset(args, config=None):
    ...
    corruption_path = args.corruption_path  # 修改


    if args.dataset in ['pacs', 'vlcs', 'pacs_aug', 'office31_aug', 'office_home_aug', 'office_caltech10_aug','domainnet_aug']:  # bypass
        ...
        if args.corruption == 'none':
            ...
            all_train_partitions, all_test_partitions, train_environments, test_environments = pickle_load(corruption_path)
